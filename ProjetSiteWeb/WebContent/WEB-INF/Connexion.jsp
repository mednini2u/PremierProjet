...
<div class="col-sm-12 controls text-center">
	<a href="./BDD" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Pr�sentation des terrains</a>
</div>
        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-success" >
                    <div class="panel-heading p-3 mb-2 bg-succes text-white">
                        <div style="float:right; font-size: 70%; position: relative; top:-6px"><a href="#">Mot de passe oubli�?</a></div>
                    </div>   
